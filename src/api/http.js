...
const instance = axios.create({
  ...
  // maxBodyLength: TIMEOUT,
  // maxRedirects: TIMEOUT,
})
// 添加请求拦截器
...
const http = (config) => {
  ...
  let defaultConfig = {
    ...
    baseURL: config.baseURL !== undefined ? config.baseURL : VITE_API_URL,
    transformRequest: [
      (data, headers) => {
        // 对发送的 data 进行任意转换处理
  ...
  return instance.request({ ...config, ...defaultConfig })
}
